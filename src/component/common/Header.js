...
const Header = () => {
  const red = useSelector((state) => state.persistedReducer);
  ...
  const [alertNotRead, setAlertNotRead] = useState([
    ...
    {
      alertContent: "긴내게시글제목긴내게시글제목긴내게시글제목",
      alertType: "댓글",
      alertCnt: 20,
      isChecked: "N",
    },
    {
      alertContent: "내댓글내용내댓글내용",
      alertType: "댓글",
      alertCnt: 9,
      isChecked: "N",
    },
    {
      alertContent: "블라인드된내게시글제목",
      alertType: "경고",
      alertCnt: 0,
      isChecked: "N",
    },
    {
      alertContent: "내문의글제목내문의글제목",
      alertType: "답변",
      alertCnt: 0,
      isChecked: "N",
    },
    {
      alertContent: "블라인드된내댓글내용",
      alertType: "경고",
      alertCnt: 0,
      isChecked: "N",
    },
